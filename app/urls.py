...
urlpatterns = [
    ...
    path('labels/', views.labels, name='app-labels'),


    path('label/<pk>/edit', LabelUpdateView.as_view(), name='label-edit'),
    path('label/<pk>/delete', LabelDeleteView.as_view(), name='label-delete'),
